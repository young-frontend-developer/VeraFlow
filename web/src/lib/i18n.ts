...
const STRINGS = {
  uz: {
    ...
    // ── learn / academy
    learn_title: "Darslar",
    learn_empty: "Darslar hali tayyor emas",
    learn_empty_body: "Tajvid darslari ustida ishlanmoqda.",
    learn_locked: "Qulflangan",
    learn_available: "Ochiq",
    learn_completed: "Tugatilgan",
    learn_lesson: "Dars",
    learn_quiz: "Savol-javob",
    learn_practice: "Mashq",
    learn_start_quiz: "Testni boshlash",
    learn_submit: "Javoblarni tekshirish",
    learn_next: "Keyingi dars",
    learn_back: "Orqaga",
    learn_score: "Natija: {n}%",
    learn_passed: "Tabriklaymiz! Siz oʻtdingiz!",
    learn_failed: "Kechirasiz, qaytadan urinib koʻring.",
    learn_pass_threshold: "Oʻtish uchun {n}% kerak",
    learn_correct: "Toʻgʻri",
    learn_wrong: "Notoʻgʻri",
    learn_practice_btn: "Mashq qilish",
    learn_practice_done: "Mashq bajarildi",
    learn_video: "Video dars",
    learn_difficulty: "Daraja",
    learn_beginner: "Boshlangʻich",
    learn_intermediate: "Oʻrta",
    learn_advanced: "Yuqori",
    learn_progress: "{done}/{total} dars",
    ...
    profile_signed_in_as: "Tizimga kirildi:",
    profile_anon_label: "Anonim foydalanuvchi",
    profile_anon_help: "Barcha imkoniyatlar mavjud. Hisob yaratish uchun quyidagi tugmani bosing.",
    profile_logout: "Tizimdan chiqish",
    profile_logout_help: "Bu qurilmadagi sessiya tugaydi.",
    profile_sign_in: "Hisob yaratish yoki kirish",
    profile_sign_in_help: "Mashqlaringiz saqlanadi va barcha qurilmalarda mavjud boʻladi.",
    profile_provider_google: "Google orqali kirgan",
    profile_provider_email: "Email orqali kirgan",
  ...
  ru: {
    ...
    learn_title: "Уроки",
    learn_empty: "Уроки ещё не готовы",
    learn_empty_body: "Уроки по таджвиду в работе.",
    learn_locked: "Заблокировано",
    learn_available: "Доступно",
    learn_completed: "Завершено",
    learn_lesson: "Урок",
    learn_quiz: "Тест",
    learn_practice: "Практика",
    learn_start_quiz: "Начать тест",
    learn_submit: "Проверить ответы",
    learn_next: "Следующий урок",
    learn_back: "Назад",
    learn_score: "Результат: {n}%",
    learn_passed: "Поздравляем! Вы прошли!",
    learn_failed: "К сожалению, попробуйте ещё раз.",
    learn_pass_threshold: "Для прохождения нужно {n}%",
    learn_correct: "Верно",
    learn_wrong: "Неверно",
    learn_practice_btn: "Практиковать",
    learn_practice_done: "Практика выполнена",
    learn_video: "Видеоурок",
    learn_difficulty: "Уровень",
    learn_beginner: "Начальный",
    learn_intermediate: "Средний",
    learn_advanced: "Продвинутый",
    learn_progress: "{done}/{total} уроков",
    ...
    profile_signed_in_as: "Вы вошли как:",
    profile_anon_label: "Анонимный пользователь",
    profile_anon_help: "Все функции доступны. Нажмите кнопку ниже, чтобы создать аккаунт.",
    profile_logout: "Выйти из аккаунта",
    profile_logout_help: "Сессия на этом устройстве завершится.",
    profile_sign_in: "Войти или создать аккаунт",
    profile_sign_in_help: "Ваша практика сохранится и будет доступна на всех устройствах.",
    profile_provider_google: "Вошли через Google",
    profile_provider_email: "Вошли через Email",
